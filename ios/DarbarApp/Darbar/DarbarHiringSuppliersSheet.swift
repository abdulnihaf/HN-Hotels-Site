...
// Darbar — Hiring manpower suppliers sheet (flow #1).
// Moved from the Hiring tab so the tab can become a 1-2-3 channel hub.
// Same read-glance-call-log flow; filter, loading/empty states, and SupplierCard rows preserved.

struct DarbarHiringSuppliersSheet: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Manpower Suppliers")
